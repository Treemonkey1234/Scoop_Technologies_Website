(()=>{var a={};a.id=9403,a.ids=[9403],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},5608:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>C,patchFetch:()=>B,routeModule:()=>x,serverHooks:()=>A,workAsyncStorage:()=>y,workUnitAsyncStorage:()=>z});var d={};c.r(d),c.d(d,{GET:()=>w});var e=c(96559),f=c(48088),g=c(37719),h=c(26191),i=c(81289),j=c(261),k=c(92603),l=c(39893),m=c(14823),n=c(47220),o=c(66946),p=c(47912),q=c(99786),r=c(46143),s=c(86439),t=c(43365),u=c(32190),v=c(84036);async function w(a){let b=new URL(`https://${v.Po.domain}/v2/logout`);b.searchParams.set("returnTo",`${v.Po.baseURL}/signin?logged_out=true`),b.searchParams.set("client_id",v.Po.clientId);let c=`
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      ...
      <script>
        ...
        try {
          ...
          // Also specifically clear any known items that might persist
          const itemsToRemove = [
            'scoopUserId',
            'scoopProfile', 
            'userJourneys',
        ...
        // Wait a moment to ensure storage is cleared, then redirect to Auth0 logout
        setTimeout(() => {
